...
Si el grafo de impacto no se pudo construir (o el equipo no tiene cables),
el factor Impacto cae a un valor neutro configurable en vez de romper el
cálculo — así el resto de la app sigue funcionando aunque el análisis de
grafo no esté disponible en el entorno.
"""
