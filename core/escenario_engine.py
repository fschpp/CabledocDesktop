...
from core.graph_impact import GraphImpactAnalyzer, ResultadoEscenario
...
class Escenario:
    ...
    def evaluar(self) -> Optional[ResultadoEscenario]:
        ...
        actuales. None si el grafo no se pudo construir (BD sin tablas de
        conexión, etc.) — la UI debe mostrar un aviso en ese caso, no
        romper."""
