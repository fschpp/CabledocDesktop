...
# a ser la RAÍZ del repo (cabledoc/), un nivel arriba de core/ — data/ es
# hermana de core/, no hija. Único cambio de comportamiento de este archivo
# en toda la Fase 1 (todo lo demás es un *move* 1:1): se sube un nivel más
# para volver a apuntar a los mismos datos de siempre.
_REPO_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
DB_PATH = os.path.join(_REPO_ROOT, "data", "database", "db.db")
IMG_DIR = os.path.join(_REPO_ROOT, "data", "imagen")
MANUALES_DIR = os.path.join(_REPO_ROOT, "data", "manuales")
PICON_DIR = os.path.join(_REPO_ROOT, "data", "picon")
SCHEMA_SQL_PATH = os.path.join(_REPO_ROOT, "data", "schema_db.sql")
