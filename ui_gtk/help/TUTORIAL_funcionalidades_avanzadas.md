...
dirigido equipo→equipo (aristas = cables) como un espejo en Python puro y
hace un BFS parcial desde las fuentes de señal afectadas. Es el mismo
grafo que reutilizan varias otras funcionalidades de esta guía (Riesgo de
Falla, Escenario).
...
una etiqueta de contenido, no alcanzabilidad): una relajación iterativa
tipo Bellman-Ford en Python puro alcanza. UI del overlay:
`senal_diagrama_ui.py`.

---

## 9. Lienzo Libre de Diagrama (Diagramas Personalizados)
