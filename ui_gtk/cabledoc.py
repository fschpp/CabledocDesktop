...
# plan_integracion_cabledoc_v3.md, Fase 2: bootstrap de sys.path para que
# `from core.X import Y` resuelva sin importar cómo se lance este archivo
# (python3 ui_gtk/cabledoc.py, ./lanzar.sh, symlink, etc.) — agrega la raíz
# del repo (padre de ui_gtk/) al principio de sys.path, una sola vez.
import os
import sys
...
try:
    from core.i18n import _, set_lang, get_lang, cargar_idioma_guardado, IDIOMAS_DISPONIBLES
...
class VentanaPrincipal(Gtk.Window):
    ...
    def _cambiar_idioma(self, widget, codigo):
        from core.i18n import set_lang, IDIOMAS_DISPONIBLES
        set_lang(codigo)
...
if __name__ == "__main__":
    import core.modelo as _modelo
    from core.modelo import DB_PATH, SCHEMA_SQL_PATH
